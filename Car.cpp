#include "Car.h"
Car::Car(glm::vec3 pos1, float l, float w, float h, GLchar* Tside, GLchar* Ttop)
{
...
float Car::RandomFloat(float a, float b) {
...
GLuint Car::loadTexture(GLchar* image)
{
...
void Car::translate(glm::vec3 pos_e) {
	glm::translate(model, pos_e - posb);
}
